...
/* harmony import */ var _components_inner_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/inner_page */ "./src/js/components/inner_page.js");
/* harmony import */ var _components_inner_page__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_inner_page__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_captcha__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/captcha */ "./src/js/components/captcha.js");
/* harmony import */ var _components_captcha__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_captcha__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _components_chat__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/chat */ "./src/js/components/chat.js");
...
/* harmony import */ var _components_dropdown__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/dropdown */ "./src/js/components/dropdown.js");
...
/***/ "./src/js/components/inner_page.js":
/*!*****************************************!*\
  !*** ./src/js/components/inner_page.js ***!
  \*****************************************/
/***/ (() => {
...
/***/ "./src/js/components/newFilter.js":
/*!****************************************!*\
  !*** ./src/js/components/newFilter.js ***!
  \****************************************/
/***/ (() => {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (popup) {
    ...
    function validateForm(context) {
      if (context.querySelector('input[type=text]').value !== '' && context.querySelector('input[type=tel]').value !== '' && context.querySelector('input[type=checkbox]').checked) {
    ...
    menuItems.forEach(function (el) {
      el.addEventListener('click', function (e) {
        if (el.querySelector('.sub-menu__ikon-wrapper') || el.querySelector('sub-menu__ikon')) {
          if (e.target.classList.contains('sub-menu__ikon-wrapper') || e.target.classList.contains('sub-menu__ikon') || e.target.tagName == 'use') {
  ...
  function maskPhone(selector) {
    let masked = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '+7(___)___-__-__';
